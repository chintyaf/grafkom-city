...
import { loadChintyaEnvironment } from "./module/chintya.js";
...
Lighting
*/
const hemisphere = new THREE.HemisphereLight(0xdbf1ff, 0x00ffff, 0.5);
...
loader.load("/models/Road Bits.glb", (gltf) => {
    ...
    const road_straight = root.children.find((c) => c.name === "road_straight");
...
const user = new User(
    ...
    camera,
    document.body,
    "/models/Character/Generic-Female.glb",
);
